...
public class BoardPanel extends UIComponent {
	...
	public BoardPanel(int x, int y, int width, int height, Board board, int tileSize, int frameSize) {
		super(x, y, width, height, frameSize, 1, 2, 2, 2);
		this.board = board;
